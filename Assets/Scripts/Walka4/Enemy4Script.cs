...
public class Enemy4Script : MonoBehaviour
{
    ...
    static public int e1unikiPO = 4;
    static public int e1gardaPO= 3;
    ...
    void Start()
    {
        ...
        e1patb = Random.Range(40, 46);
        e1satb = Random.Range(25, 31);
        e1vit = Random.Range(14, 18)*10;
        e1garde = 45;
        ...
        e1level = 4;
        e1baseattack = 1;
        e1obr = E4ModifiScript.obrazenia;
        e1maxHealth = e1vit;
